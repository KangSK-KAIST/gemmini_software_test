...
#define ROCC_INSTRUCTION_RAW_R_R_R(x, rd, rs1, rs2, func7) \
  printf("raw_r_r_r] cat: %s, %d, func7: %d, rd: %d, rs1: %d, rs2: %d\n", CAT(CUSTOM_, x), 7, func7, rd, rs1, rs2);
...
#define ROCC_INSTRUCTION_RAW_0_R_R(x, rs1, rs2, func7) \
  printf("raw_0_r_r] cat: %s, %d, func7: %d, x0: %d, rs1: %d, rs2: %d\n", CAT(CUSTOM_, x), 3, func7, x0, rs1, rs2);
...
#define ROCC_INSTRUCTION_R_R_R(x, rd, rs1, rs2, func7) \
    printf("_r_r_r] cat: %s, %d, func7: %d, rd: %d, rs1: %d, rs2: %d\n", STR(CAT(CUSTOM_, x)), 7, func7, rd, rs1, rs2);
...
#define ROCC_INSTRUCTION_0_R_R(x, rs1, rs2, func7) \
    printf("raw_r_r_r] cat: %s, %d, func7: %d, 0: %d, rs1: %d, rs2: %d\n", STR(CAT(CUSTOM_, x)), 3, func7, 0, rs1, rs2);
